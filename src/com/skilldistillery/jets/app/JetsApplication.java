...
//				break;
	...
	public void displayMenu() {
		...
		System.out.println(" | 6: *Splash land*               | ");
	...
	public void fly() {
		...
		for (Jet plane : jets) {
			...
			System.out.println("The "+ plane.getModel() + " can fly for " + roundedTime + " hours.");
		}
	}
	...
	public void viewFastestJet() {
		...
		for (Jet plane : jets) {
			...
			if (plane.getSpeed() > fastestJet.getSpeed()) {
				...
				System.out.println(fastestJet.getModel() + " has the highest top speed at: " + fastestJet.getSpeed()
						+ " miles per hour.");
	...
	public void viewLongestRange() {
		...
		for (Jet plane : jets) {
			...
			if (plane.getRange() > longestRange.getRange()) {
				...
				System.out.println(
						longestRange.getModel() + " has the longest range at: " + longestRange.getRange() + " miles.");
	}
